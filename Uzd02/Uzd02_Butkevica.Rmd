...
```{r, reading shapefile, echo=TRUE, results='hide', warning = FALSE, message = FALSE}
...
```{r, format conversion, echo=TRUE, results='hide', warning = FALSE, message = FALSE}
...
```{r, speed measurements, echo=TRUE, results='hide', warning = FALSE, message = FALSE}
...
```{r, remove files and vriables from first task, echo=TRUE, results='hide', warning = FALSE, message = FALSE}
...
```{r, shape files to parquet, echo=TRUE, results='hide', warning = FALSE, message = FALSE}
