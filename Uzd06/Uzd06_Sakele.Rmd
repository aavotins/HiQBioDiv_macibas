...
Jāizburas cauri dokumentiem, lai saprastu, kas īsti prasīts un kā to dabūt...
...
- 81: Egle, osis, liepa, goba, vīksna un kļava + līdzīgās sugas un visas citas
...
2. vidēja vecuma audze – starp jaunaudzi un briestaudzi (2 x vecumklase līdz ciršanas vecums – 1 vecumklase)
3. briestaudze – viena vecumklase pirms pieaugušas audzes (ciršanas) (ciršanas vecum – 1 vecumklase līdz ciršanas vecums)
4. pieauguša audze – divas vecumklases, sākot ar ciršanas vecumu (ciršanas vecums līdz ciršanas vecums + 2 x vecumklase)
5. pārauguša audze – pārsniedz pieaugušas audzes vecumu (lielāks par ciršanas vecums +2 vecumklases)
...
Vecumgrupu vajag ievietot jau esošajā meža tipu klasifikatorā kā otro ciparu. Tad, to pareizinot ar 10, iegūst, ka tas būs pirmais cipars divciparu skaitlī. Turklāt abi jau glabājas kā skaitliskas vērtības.
```{r cache=TRUE}
...
```
Sanāca arī viens tif ar klasi NA. To kādreiz vajadzētu izpētīt, kāpēc tāda radās. Mežaudzes tipu līmenī visas klases bija normālas. 
...
```
Tā gan nebūs īsti tikai sauszemes teritorija, bet drīzāk gan iekšzemes teritorija, jo ezeri, upes ir ieskaitītas šeit kā sauszeme.
```{r}
rm(list = ls())
```
